...
<template>
  <div>
    <!-- ADD MODAL -->
    <div
      class="fixed top-0 left-0 right-0 z-50 w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-full max-h-full flex items-center justify-center bg-black/50"
          ...
          <div class="px-6 py-6 lg:px-8">
            ...
            <form class="space-y-6" action="#">
              <div>
                <label
                  for="countries"
                  class="block mb-2 text-sm font-medium text-yellow-900 dark:text-yellow-300 dark:bg-yellow-500/50 bg-yellow-300 rounded-md text-center p-1"
                  >Qaysi fanga qo'shmoqchisiz</label
                >
                <select
                  id="countries"
