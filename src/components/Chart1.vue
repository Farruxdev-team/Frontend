<script setup>
  ...
  const options = reactive({
          ...
          data: [{
            ...
            showInLegend: true,
            color: "#012066",
            toolTipContent: "<img src=\"https://canvasjs.com/wp-content/uploads/images/gallery/javascript-column-bar-charts/japan.png\" style=\"height:11px;width:18px;\"> {name}: {y}",
            dataPoints: [
              { label: "2015", y: 5200.9 },
              { label: "2016", y: 5159.7 },
              { label: "2017", y: 5248.4 },
